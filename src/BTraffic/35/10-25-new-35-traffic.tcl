#
# nodes: 35, max conn: 35, send rate: 0.20000000000000001, seed: 1
#
#
...
$ns_ attach-agent $node_(26) $null_(21)
...
$ns_ attach-agent $node_(27) $udp_(22)
set null_(22) [new Agent/Null]
$ns_ attach-agent $node_(28) $null_(22)
...
$ns_ attach-agent $node_(28) $udp_(23)
set null_(23) [new Agent/Null]
$ns_ attach-agent $node_(29) $null_(23)
...
$ns_ attach-agent $node_(29) $udp_(24)
set null_(24) [new Agent/Null]
$ns_ attach-agent $node_(30) $null_(24)
...
$ns_ attach-agent $node_(29) $udp_(25)
set null_(25) [new Agent/Null]
$ns_ attach-agent $node_(31) $null_(25)
...
$ns_ attach-agent $node_(34) $udp_(26)
set null_(26) [new Agent/Null]
$ns_ attach-agent $node_(0) $null_(26)
...
#$ns_ attach-agent $node_(34) $udp_(27)
#set null_(27) [new Agent/Null]
#$ns_ attach-agent $node_(0) $null_(27)
...
#
#Total sources/connections: 18/28
#
