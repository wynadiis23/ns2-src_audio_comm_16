#
# nodes: 75, max conn: 15, send rate: 0.20000000000000001, seed: 1
#
#
...
$ns_ attach-agent $node_(14) $udp_(2)
...
$ns_ attach-agent $node_(16) $udp_(3)
...
$ns_ attach-agent $node_(17) $udp_(5)
...
$ns_ attach-agent $node_(18) $udp_(6)
...
$ns_ attach-agent $node_(20) $null_(7)
...
$ns_ attach-agent $node_(21) $null_(8)
...
$ns_ attach-agent $node_(23) $null_(10)
...
$ns_ attach-agent $node_(23) $udp_(11)
set null_(11) [new Agent/Null]
$ns_ attach-agent $node_(24) $null_(11)
...
$ns_ attach-agent $node_(26) $null_(13)
