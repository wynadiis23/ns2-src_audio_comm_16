#
# nodes: 25, max conn: 25, send rate: 0.20000000000000001, seed: 1
#
#
...
$ns_ attach-agent $node_(20) $udp_(3)
...
$ns_ attach-agent $node_(16) $null_(12)
...
$ns_ attach-agent $node_(16) $udp_(13)
...
$ns_ attach-agent $node_(16) $udp_(14)
set null_(14) [new Agent/Null]
$ns_ attach-agent $node_(18) $null_(14)
...
$ns_ attach-agent $node_(17) $udp_(15)
set null_(15) [new Agent/Null]
$ns_ attach-agent $node_(18) $null_(15)
...
$ns_ attach-agent $node_(17) $udp_(16)
set null_(16) [new Agent/Null]
$ns_ attach-agent $node_(19) $null_(16)
...
$ns_ attach-agent $node_(19) $null_(17)
...
$ns_ attach-agent $node_(5) $null_(18)
...
$ns_ attach-agent $node_(21) $udp_(19)
set null_(19) [new Agent/Null]
$ns_ attach-agent $node_(2) $null_(19)
...
$ns_ attach-agent $node_(21) $udp_(20)
set null_(20) [new Agent/Null]
$ns_ attach-agent $node_(0) $null_(20)
...
#$ns_ attach-agent $node_() $udp_(21)
#set null_(21) [new Agent/Null]
#$ns_ attach-agent $node_(0) $null_(21)
...
#
#Total sources/connections: 14/22
#
