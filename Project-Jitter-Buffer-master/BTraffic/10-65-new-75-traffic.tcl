#
# nodes: 75, max conn: 75, send rate: 0.20000000000000001, seed: 1
#
#
# 1 connecting to 2 at time 2.5568388786897245
#
set udp_(0) [new Agent/UDP]
$ns_ attach-agent $node_(75) $udp_(0)
set null_(0) [new Agent/Null]
$ns_ attach-agent $node_(74) $null_(0)
...
$ns_ attach-agent $node_(72) $udp_(1)
set null_(1) [new Agent/Null]
$ns_ attach-agent $node_(71) $null_(1)
...
$ns_ attach-agent $node_(72) $udp_(2)
...
$ns_ attach-agent $node_(70) $udp_(3)
set null_(3) [new Agent/Null]
$ns_ attach-agent $node_(69) $null_(3)
...
$ns_ attach-agent $node_(69) $udp_(4)
set null_(4) [new Agent/Null]
$ns_ attach-agent $node_(68) $null_(4)
...
$ns_ attach-agent $node_(69) $udp_(5)
set null_(5) [new Agent/Null]
$ns_ attach-agent $node_(67) $null_(5)
...
$ns_ attach-agent $node_(68) $udp_(6)
set null_(6) [new Agent/Null]
$ns_ attach-agent $node_(67) $null_(6)
...
$ns_ attach-agent $node_(67) $udp_(7)
set null_(7) [new Agent/Null]
$ns_ attach-agent $node_(66) $null_(7)
...
$ns_ attach-agent $node_(67) $udp_(8)
...
$ns_ attach-agent $node_(36) $udp_(30)
set null_(30) [new Agent/Null]
$ns_ attach-agent $node_(38) $null_(30)
...
$ns_ attach-agent $node_(38) $udp_(31)
set null_(31) [new Agent/Null]
$ns_ attach-agent $node_(39) $null_(31)
...
$ns_ attach-agent $node_(38) $udp_(32)
set null_(32) [new Agent/Null]
$ns_ attach-agent $node_(40) $null_(32)
...
$ns_ attach-agent $node_(41) $udp_(33)
set null_(33) [new Agent/Null]
$ns_ attach-agent $node_(42) $null_(33)
...
$ns_ attach-agent $node_(41) $udp_(34)
set null_(34) [new Agent/Null]
$ns_ attach-agent $node_(43) $null_(34)
...
$ns_ attach-agent $node_(42) $udp_(35)
set null_(35) [new Agent/Null]
$ns_ attach-agent $node_(43) $null_(35)
...
$ns_ attach-agent $node_(42) $udp_(36)
set null_(36) [new Agent/Null]
$ns_ attach-agent $node_(44) $null_(36)
...
$ns_ attach-agent $node_(43) $udp_(37)
set null_(37) [new Agent/Null]
$ns_ attach-agent $node_(44) $null_(37)
...
$ns_ attach-agent $node_(43) $udp_(38)
...
$ns_ attach-agent $node_(44) $udp_(40)
set null_(40) [new Agent/Null]
$ns_ attach-agent $node_(46) $null_(40)
