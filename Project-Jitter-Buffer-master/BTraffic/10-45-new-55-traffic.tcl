#
# nodes: 55, max conn: 55, send rate: 0.20000000000000001, seed: 1
#
#
# 1 connecting to 2 at time 2.5568388786897245
#
set udp_(0) [new Agent/UDP]
$ns_ attach-agent $node_(55) $udp_(0)
set null_(0) [new Agent/Null]
$ns_ attach-agent $node_(54) $null_(0)
...
$ns_ attach-agent $node_(52) $udp_(1)
set null_(1) [new Agent/Null]
$ns_ attach-agent $node_(51) $null_(1)
...
$ns_ attach-agent $node_(52) $udp_(2)
...
$ns_ attach-agent $node_(50) $udp_(3)
set null_(3) [new Agent/Null]
$ns_ attach-agent $node_(49) $null_(3)
...
$ns_ attach-agent $node_(48) $null_(4)
...
$ns_ attach-agent $node_(49) $udp_(5)
set null_(5) [new Agent/Null]
$ns_ attach-agent $node_(47) $null_(5)
...
$ns_ attach-agent $node_(48) $udp_(6)
set null_(6) [new Agent/Null]
$ns_ attach-agent $node_(47) $null_(6)
...
$ns_ attach-agent $node_(47) $udp_(7)
set null_(7) [new Agent/Null]
$ns_ attach-agent $node_(46) $null_(7)
...
$ns_ attach-agent $node_(47) $udp_(8)
...
$ns_ attach-agent $node_(9) $null_(38)
...
$ns_ attach-agent $node_(8) $null_(40)
...
$ns_ attach-agent $node_(7) $udp_(41)
...
$ns_ attach-agent $node_(3) $udp_(42)
set null_(42) [new Agent/Null]
$ns_ attach-agent $node_(2) $null_(42)
...
#
#Total sources/connections: 27/43
#
