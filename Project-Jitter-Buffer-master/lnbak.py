...
##############################
###########misalkan 10 replikasi, maka baris dalam files csv akan ada 11, dengan baris ke 11 adalah rata2 dari replikasi
nnode=sys.argv[1]
codec=sys.argv[2]


#path
path_packetloss='/home/adisaputra/NS/voip/Project-Jitter-Buffer-master/awk/packetloss/'+'AOMDV'+'_'+str(codec)+'_pktloss_'+str(nnode)+'.txt'
path_delay='/home/adisaputra/NS/voip/Project-Jitter-Buffer-master/awk/delay/'+'AOMDV'+'_'+str(codec)+'_delay_'+str(nnode)+'.txt'
