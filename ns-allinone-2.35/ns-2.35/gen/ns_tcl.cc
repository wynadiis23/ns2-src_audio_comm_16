...
\"\n\
checkout_executable TCLSH \"/home/adisaputra/NS/voip/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/adisaputra/NS/voip/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
set pa_aodvonly [string first \"PA_AODV\" [$agent info class]] \n\
if {$pa_aodvonly != -1 } {\n\
$agent if-queue [$self set ifq_(0)]   ;# ifq between LL and MAC\n\
}\n\
\n\
...
\n\
Agent/PA_AODV instproc init args {\n\
\n\
$self next $args\n\
}\n\
Agent/PA_AODV set sport_   0\n\
Agent/PA_AODV set dport_   0\n\
\n\
...
PA_AODV {\n\
set ragent [$self create-pa_aodv-agent $node]\n\
}\n\
AOMDV {\n\
...
\n\
Simulator instproc create-pa_aodv-agent { node } {\n\
set ragent [new Agent/PA_AODV [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"     ;# start BEACON/HELLO Messages\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
